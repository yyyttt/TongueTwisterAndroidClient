...
public class PassThroughGradeActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.iv_repeat:
			Intent repeatIntent = new Intent(this, PassThroughItemActivity.class);
	...
	private void initPCMData() {
		...
		// 获取音频数据
		filePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/outfile" + number + ".pcm";
