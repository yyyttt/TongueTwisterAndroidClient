...
public class ScrollLayout extends ViewGroup {
	...
	public void snapToScreen(int whichScreen) {
		...
		if (getScrollX() != (whichScreen * getWidth())) {
			...
			if (mCurScreen > Constant.curentPage) {
				Constant.curentPage = whichScreen;
				pageListener.page(Constant.curentPage);
			} else if (mCurScreen < Constant.curentPage) {
				Constant.curentPage = whichScreen;
				pageListener.page(Constant.curentPage);
			}
